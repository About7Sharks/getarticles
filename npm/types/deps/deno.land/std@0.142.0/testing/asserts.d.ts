...
export declare function assertFalse(expr: unknown, msg?: string): asserts expr is false;
/**
...
export declare function assertThrows(fn: () => unknown, errorCallback: (e: Error) => unknown, msg?: string): Error;
/** Executes a function which returns a promise, expecting it to reject. */
export declare function assertRejects(fn: () => Promise<unknown>, msg?: string): Promise<unknown>;
/** Executes a function which returns a promise, expecting it to reject.
 * If it does not, then it throws. An error class and a string that should be
 * included in the error message can also be asserted. */
export declare function assertRejects<E extends Error = Error>(fn: () => Promise<unknown>, ErrorClass: new (...args: any[]) => E, msgIncludes?: string, msg?: string): Promise<E>;
/** @deprecated Use assertRejects(fn, msg) instead, which now returns rejected value
 * and you can assert on it. */
export declare function assertRejects(fn: () => Promise<unknown>, errorCallback: (e: Error) => unknown, msg?: string): Promise<Error>;
